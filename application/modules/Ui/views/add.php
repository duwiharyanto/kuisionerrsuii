  ...
  <div class="col-sm-12">
    <div class="table-responsive">
      <form class="needs-validation" novalidate="" url="<?= base_url($setting['url'].'/add')?>">
        ...
        <div class="form-group">
          <label>Nama</label>
          <input required type="text" class="form-control reset" name="kuisioner_nama">
          <?=validationmsg('required')?>
        </div>
        <div class="form-group">
          <label>Unit Kerja</label>
          <input required type="text" class="form-control reset" name="kuisioner_unitkerja">
          <?=validationmsg('required')?>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
          ...
          <textarea required type="text" class="form-control reset" name="kuisioner_alamatdomisili"></textarea>
          <?=validationmsg('required')?>
        </div>
        <hr>
        <?php $i=1;?>                        
        ...
        <div id="pesanberhasil" class="text-danger">         
        </div>                  
      </form>     
    </div>
  </div>
